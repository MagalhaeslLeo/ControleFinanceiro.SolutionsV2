document.addEventListener('DOMContentLoaded', function () {
    ...
    //Seleciona todos os formulários de edição
    var forms = document.querySelectorAll('form.editar-receita');

    //Percorre todos os formulários obtidos para as validações dos campos do formulário
    forms.forEach(function (form) {
        ...
        if (descricao && valor && periodo && atualizarSubmitButton) {
